        ...
        <div class="register-body">
            <form class="register-form-wrapper" method="POST" action="{{ route('register') }}">
                ...
                <fieldset class="form-fields">
                    <div name="name" class="form-group mt-4">
                    ...
                    <div name="password" class="form-group mt-4">
                        <x-text-input id="customer-password" name="customer-password" name="password"
                    ...
                    <div name="comfirmation-password" class="form-group mt-4">
                        <x-text-input id="password-confirmation" name="password_confirmation"
                            class="block mt-1 w-full" type="password"
                    ...
                    <div name="customer-gender" class="form-group mt-4">
                        <div class="">
                            <select id="customer-gender" name="gender" title="Giới tính"
                    ...
                    <div name="policy-agreement" class="form-group mt-4">
                        ...
                        <x-input-error :messages="$errors->get('agree_policy')" class="mt-2" />
                    </div>

                    <div name="discount-choice" class="mt-4">
                        <input type="hidden" name="receive_discount" value="0">
                        <x-text-input id="discount-checkbox"
                            type="checkbox"
                            name="receive_discount"
                            value="1" />

                        <label>Nhận chương trình khuyến mãi qua email</label>
                        <x-input-error :messages="$errors->get('receive_discount')" class="mt-2" />
                    </div>
